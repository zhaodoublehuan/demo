		...
		"columnDefs":[
			{
			 ...
			 "render":function( data, type, row, meta){
			 	var btnHtml = '<button class="btn btn-success btn-xs" onclick="editShop('+row.id+')"><i class="fa fa-fw fa-edit"></i></button>';
			 	btnHtml += '<button class="btn btn-danger btn-xs" onclick="delShop('+row.id+')"><i class="fa fa-fw fa-remove"></i></button>';
			 	return btnHtml;
			 }
			}
		],
